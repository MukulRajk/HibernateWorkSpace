...
//	public void deposit(double amount){ balance=super.getBalance()+amount;}
...
case 1:
	...
	System.out.println("enter Amount to be deposited :"+amount);
	AccountHolder ah=new AccountHolder(null, null, getBalance());
	ch.deposit(amount);
